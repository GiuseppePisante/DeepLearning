...
class ImageGenerator:
    ...
    def next(self):
        ...
        # Create empty images and labes batches
        batch_images = []
        batch_labels = []
        ...
        for _ in range(self.batch_size):
            ...
            if self.shuffle and self.index:
                np.random.shuffle(self.image_files)

            # Reset the index, increment the epoch (and shuffle) if we have used all the images
            ...
            # Get the current image and its path
            ...
            # Append the new image, the label and increment the index
